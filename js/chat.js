...
function updateCalculatedCost() {
    ...
    if (tabType === 'image') {
        ...
        let perSec = 0;
        if (resolution === '1080p') perSec = parseFloat(settings.video_1080p_cost || 0.30);
        else if (resolution === '720p') perSec = parseFloat(settings.video_720p_cost || 0.18);
        else perSec = parseFloat(settings.video_480p_cost || 0.10);
